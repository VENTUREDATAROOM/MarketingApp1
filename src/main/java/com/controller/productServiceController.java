...
public class productServiceController {
	...
	@PostMapping(value="/add/productService",consumes=MediaType.MULTIPART_FORM_DATA_VALUE)
	public ResponseEntity<?> addDataOfProductService(@RequestParam("image") MultipartFile fileImage,
			@RequestParam("ProductServiceName") String productName,
			@RequestParam("description") String description) {
		try {
			productService productData = this.productserviceService.addProductService(productName,description,fileImage);
			if (productData == null) {
